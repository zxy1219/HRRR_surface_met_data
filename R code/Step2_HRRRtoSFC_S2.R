...
# Scenario 2 (set max or min limits for certain parameters, not consider SBL or CBL). 
# Major parameters:
...
write.csv(hrrr1,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[1],".csv"),row.names = F)
write.csv(hrrr2,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[2],".csv"),row.names = F)
write.csv(hrrr3,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[3],".csv"),row.names = F)
write.csv(hrrr4,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[4],".csv"),row.names = F)
write.csv(hrrr5,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[5],".csv"),row.names = F)
write.csv(hrrr6,paste0("/home/xzhang/gfs/outputs/NO2_sites/Step2_v2/HRRRv2_2019_ID",site_grid_id[6],".csv"),row.names = F)
